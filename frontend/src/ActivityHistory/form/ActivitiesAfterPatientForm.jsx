...
class ActivitiesAfterPatientForm extends React.Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit(e) {
        ...
        doctorService.getPatientActivitiesByDay(this.state.patientSelected.value, dateSelected)
            .then(
                activities => {
                    this.props.callback(activities);
                }
            );
    }
...
export {ActivitiesAfterPatientForm};