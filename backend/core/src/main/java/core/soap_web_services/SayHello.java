...
public class SayHello {
    ...
    @XmlElementRef(name = "name", namespace = "soap_web_services.core", type = JAXBElement.class, required = false)
    protected JAXBElement<String> name;
    @XmlElementRef(name = "times", namespace = "soap_web_services.core", type = JAXBElement.class, required = false)
